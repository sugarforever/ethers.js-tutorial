/**
 * This is an example referring to https://raw.githubusercontent.com/WTFAcademy/WTF-Ethers/main/05_WriteContract/WriteContract.js
 */
...
// 本代码在WTF的原始示例代码的基础上替换为如下Infura测试网endpoint
...
const main = async () => {
    ...
    if(ethers.utils.formatEther(balanceETH) > 0.0015){
        ...
        console.log(`存款后WETH持仓原始值: ${balanceWETH_deposit}\n`)
